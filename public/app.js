...
function render() {
  ...
  wTipsEl = document.getElementById('wTips');
  if (wTipsEl) wTipsEl.textContent = sym + wTips.toFixed(2);
  ...
  mTipsEl = document.getElementById('mTips');
  if (mTipsEl) mTipsEl.textContent = sym + mTips.toFixed(2);
  ...
  if (!editMode) {
    ...
    document.getElementById('viewModalBody').innerHTML = `
      ...
      <div class="view-section">
        <div class="view-section-title">&#128176; Earnings</div>
        <div class="view-grid">
          <div class="view-item"><span class="view-item-label">Tips</span><input class="edit-input" id="edit_tips" type="number" value="${entry.tips || 0}" step="0.01"></div>
        </div>
      </div>
      <div class="view-section">
        <div class="view-section-title">&#128179; Expenses</div>
...
async function saveEditMode() {
  ...
  // Read all dynamic work detail fields
  fieldConfig.workDetails.forEach(field => {
    if (field.id === 'date' || field.id === 'time_in' || field.id === 'time_out') return;
  ...
  // Read tips
  let tipsEl = document.getElementById('edit_tips');
  if (tipsEl) entry.tips = parseFloat(tipsEl.value) || 0;
