...
function render() {
  ...
  filtered.forEach(e => {
    ...
    tr.innerHTML = `
      ...
      <td><input class="cell-input" type="number" value="${e.tips || 0}" step="0.01" onchange="updateEntryField(${e.id}, 'tips', parseFloat(this.value)||0)"></td>
      ...
      <td class="grocCol"><input class="cell-input" type="number" value="${e.grocery}" step="0.01" onchange="updateEntryField(${e.id}, 'grocery', parseFloat(this.value)||0)"></td>
      <td class="phoneCol"><input class="cell-input" type="number" value="${e.phone}" step="0.01" onchange="updateEntryField(${e.id}, 'phone', parseFloat(this.value)||0)"></td>
      <td class="wifiCol"><input class="cell-input" type="number" value="${e.wifi}" step="0.01" onchange="updateEntryField(${e.id}, 'wifi', parseFloat(this.value)||0)"></td>
      <td class="foodCol"><input class="cell-input" type="number" value="${e.food}" step="0.01" onchange="updateEntryField(${e.id}, 'food', parseFloat(this.value)||0)"></td>
      <td class="maintCol"><input class="cell-input" type="number" value="${e.maintenance}" step="0.01" onchange="updateEntryField(${e.id}, 'maintenance', parseFloat(this.value)||0)"></td>
      <td class="insurCol"><input class="cell-input" type="number" value="${e.insurance}" step="0.01" onchange="updateEntryField(${e.id}, 'insurance', parseFloat(this.value)||0)"></td>
      <td class="miscCol"><input class="cell-input" type="number" value="${e.misc}" step="0.01" onchange="updateEntryField(${e.id}, 'misc', parseFloat(this.value)||0)"></td>
      <td class="otherCol"><input class="cell-input" type="number" value="${e.other}" step="0.01" onchange="updateEntryField(${e.id}, 'other', parseFloat(this.value)||0)"></td>
