...
function render() {
  ...
  filtered.forEach(e => {
    ...
    tr.innerHTML = `
      <td><input class="cell-input" value="${e.date}" onchange="updateEntryField(${e.id}, 'date', this.value)" style="min-width:90px"></td>
      <td><input class="cell-input" value="${e.time_in}" onchange="updateEntryField(${e.id}, 'time_in', this.value)" style="text-align:center"></td>
      <td><input class="cell-input" value="${e.time_out}" onchange="updateEntryField(${e.id}, 'time_out', this.value)" style="text-align:center"></td>
      ...
      <td><input class="cell-input" type="number" value="${e.km}" step="0.1" onchange="updateEntryField(${e.id}, 'km', parseFloat(this.value)||0)" style="text-align:center"></td>
      <td class="delivCol"><input class="cell-input" type="number" value="${e.deliveries}" onchange="updateEntryField(${e.id}, 'deliveries', parseInt(this.value)||0)" style="text-align:center"></td>
      <td><input class="cell-input" type="number" value="${e.tips || 0}" step="0.01" onchange="updateEntryField(${e.id}, 'tips', parseFloat(this.value)||0)" style="text-align:right"></td>
      <td><input class="cell-input" type="number" value="${e.fuel}" step="0.01" onchange="updateEntryField(${e.id}, 'fuel', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="grocCol"><input class="cell-input" type="number" value="${e.grocery}" step="0.01" onchange="updateEntryField(${e.id}, 'grocery', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="phoneCol"><input class="cell-input" type="number" value="${e.phone}" step="0.01" onchange="updateEntryField(${e.id}, 'phone', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="wifiCol"><input class="cell-input" type="number" value="${e.wifi}" step="0.01" onchange="updateEntryField(${e.id}, 'wifi', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="foodCol"><input class="cell-input" type="number" value="${e.food}" step="0.01" onchange="updateEntryField(${e.id}, 'food', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="maintCol"><input class="cell-input" type="number" value="${e.maintenance}" step="0.01" onchange="updateEntryField(${e.id}, 'maintenance', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="insurCol"><input class="cell-input" type="number" value="${e.insurance}" step="0.01" onchange="updateEntryField(${e.id}, 'insurance', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="miscCol"><input class="cell-input" type="number" value="${e.misc}" step="0.01" onchange="updateEntryField(${e.id}, 'misc', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="otherCol"><input class="cell-input" type="number" value="${e.other}" step="0.01" onchange="updateEntryField(${e.id}, 'other', parseFloat(this.value)||0)" style="text-align:right;color:var(--danger)"></td>
      <td class="${e.daily_profit >= 0 ? 'cell-profit' : 'cell-loss'}" style="text-align:right;font-weight:800">$${e.daily_profit.toFixed(2)}</td>
      <td><input class="cell-input" value="${e.notes || ''}" onchange="updateEntryField(${e.id}, 'notes', this.value)" style="min-width:150px"></td>
      <td style="text-align:center"><button class="delete-btn" onclick="deleteEntry(${e.id})">🗑</button></td>
    `;
